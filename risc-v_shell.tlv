...
\SV
   ...
   ------------------------------------------------------------
   //////////////////////////////////////////////
   /////////FINAL-DAY-4-complete-bug free code after functional verification////////////////
   //////////////////////////////////////////////////////////////////////////////////
   --------------------------------------------------------------------------------
...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         //sart signal
         $reset_d = >>1$reset ? 1:0;
         $start = (!$reset && $reset_d) ? 1:0;
         
         $valid3 = $start ? $start : >>3$valid;
         ...
         $imm[31:0] = $is_i_instr ? { {21{$instr[31]}}, $instr[30:20]} :
                      ...
                      $is_b_instr ? { {20{$instr[31]}}, $instr[7], $instr[30:25], $instr[11:8],1'h0}:
                      $is_u_instr ? {$instr[31], $instr[30:20], $instr[19:12], 12'h0}:
                      $is_j_instr ? { {12{$instr[31]}}, $instr[19:12], $instr[20], $instr[30:25], $instr[24:21],1'h0} : 32'h0;
         ...
         ?$rs1_valid
            $rs1[4:0] = $instr[19:15];
         $opc_valid = $is_r_instr || $is_s_instr || $is_b_instr || $is_i_instr || $is_u_instr || $is_j_instr;
         ?$opc_valid
